...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `act` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L446" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `instruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L523" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `instruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L541" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L760" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L774" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L788" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aact` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L801" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L871" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L891" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L911" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `ainstruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L930" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aquery` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L1086" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
...
#### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `aquery` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/session.py#L1097" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>
