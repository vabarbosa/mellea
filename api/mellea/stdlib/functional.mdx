...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `act` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/functional.py#L71" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
act(action: Component[S], context: Context, backend: Backend) -> tuple[ComputedModelOutputThunk[S], Context] | SamplingResult[S]
```
...
**Returns:**
- A (ComputedModelOutputThunk, Context) if `return_sampling_results` is `False`, else returns a [`SamplingResult`](../core/sampling#class-samplingresult).
- Always returns ComputedModelOutputThunk since sync functions must await completion.


<div className="w-full h-px bg-gray-200 dark:bg-gray-700 my-4" />

### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `instruct` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/functional.py#L169" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
instruct(description: str, context: Context, backend: Backend) -> tuple[ComputedModelOutputThunk[str], Context] | SamplingResult[str]
```
...
### <span className="ml-2 inline-flex items-center rounded-full px-2 py-1 text-[0.7rem] font-bold tracking-wide bg-[#3064E3]/20 text-[#1D4ED8]">FUNC</span> `query` <sup><a href="https://github.com/generative-computing/mellea/blob/v0.4.2/mellea/stdlib/functional.py#L340" target="_blank"><Icon icon="github" style="width: 14px; height: 14px;" /></a></sup>

```python
query(obj: Any, query: str, context: Context, backend: Backend) -> tuple[ComputedModelOutputThunk, Context]
```
